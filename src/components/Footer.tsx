        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          <div>
            <div className="flex items-center space-x-2 mb-6">
              ...
              <span className="text-xl font-bold">PawsomeCare</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#team" className="text-blue-200 hover:text-white transition-colors">Our Team</a></li>
              <li><a href="#careers" className="text-blue-200 hover:text-white transition-colors">Careers</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#features" className="text-blue-200 hover:text-white transition-colors">AI Pet Assistance</a></li>
              <li><a href="#features" className="text-blue-200 hover:text-white transition-colors">Rescue Community</a></li>
              <li><a href="#pricing" className="text-blue-200 hover:text-white transition-colors">Pricing Plans</a></li>
              <li><a href="#" className="text-blue-200 hover:text-white transition-colors">Support Center</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-blue-800 pt-8 mt-8">
          <div className="grid md:grid-cols-2 gap-4 items-center">
            <p className="text-blue-200 text-sm">
              &copy; {new Date().getFullYear()} PawsomeCare. All rights reserved.
            </p>
